 ...
 * game_logic.c - all the functions which commit the game commands themselves
 ...
 * helper_functions.chg - generic helper functions which are not directly related to the game itself.
 *
 ...
 *
 * This is the way which gave us the optimal value for explicit declarations and splitting, modularity and balancing the code
